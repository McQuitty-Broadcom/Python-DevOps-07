...
- Your login: is _SNCUST007
- The password is _SNCUST007
...
- Your userid is CUST007.
- Your password _MFCUST007.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate element DOGGOS07 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate element DOGGOS07 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset _MFCUST007.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST007.PUBLIC.JCL(NDRUNDOG)" --vasc`
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-07.git`
