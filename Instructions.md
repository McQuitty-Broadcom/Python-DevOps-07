...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS07 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS07 --type LNK --os --maxrc 0 --sn 1 --cb`
...
`zowe jobs submit data-set "CUST007.MARBLES.JCL(MARBCOPY)" --vasc`
